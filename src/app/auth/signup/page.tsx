    ...
    <div className="w-full max-w-md mx-auto">
      ...
      <div className="text-center mb-6">
        ...
        <p className="text-xs text-slate-500 dark:text-purple-200/60 mt-1.5">
          Sign up with Open account or enter your account details.
        </p>
      </div>
      ...
      <form onSubmit={handleSignUp} className="space-y-3.5">
        <div className="space-y-1.5">
          <label htmlFor="fullName" className="text-xs font-medium text-slate-700 dark:text-purple-200/80">
            Full name
          </label>
          <div className="relative">
            <User className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-400 dark:text-purple-400/60" />
            <input
              id="fullName"
              type="text"
